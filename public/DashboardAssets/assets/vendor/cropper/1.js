              ...
              $('#saveImageBtn').on('click', function () {
                ...
                fetch('http://localhost:3001/api/cropImage', {
                  ...
                  .then(data => {
                    ...
                    // Show cropped image everywhere
                    var imageElement = document.createElement('img');
                    imageElement.src = imageData;
  
                    var previewContainer = document.querySelector('.image-preview-container');
                    previewContainer.style.display = 'flex'; // Make the container visible
                    previewContainer.style.width = '100px';  // Set width to 100px
                    previewContainer.style.height = '100px'; // Set height to 100px
                    ...
                    // var lastImage = previewContainer.lastElementChild;
                    // if (lastImage) {
                    //   previewContainer.removeChild(lastImage);
                    // }
  
                    // Then append the new image
                    previewContainer.appendChild(imageElement);
  
                    // Assuming you want to show it in multiple divs with class "image-container"
                    var containers = document.querySelectorAll('.image-container');
                    containers.forEach(function (container) {
                      container.appendChild(imageElement.cloneNode()); // Add image to each container
                    });
