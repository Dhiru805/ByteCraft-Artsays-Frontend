$(function () {
  ...
  $('.docs-buttons').on('click', '[data-method]', function () {
    ...
    previewContainer.style.display = 'block'; // Make the container visible
    ...
    previewContainer.appendChild(imageElement);
                  ...
                  $image.cropper('replace', imageData); // This replaces the image in the cropper box with the cropped image
              })
              .catch(error => {
