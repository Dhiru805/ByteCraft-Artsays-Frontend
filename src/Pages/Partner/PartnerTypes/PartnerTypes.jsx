            ...
            return (
              <button
                ...
                className={`w-full md:w-1/4 border-2 p-3 rounded-2xl flex flex-col items-center gap-3
                                            ...
                                            ${
                                              active
                                                ? "border-[#48372D] shadow-2xl shadow-[0_10px_5px_-4px_rgba(0,0,0,0.3)]"
                                                : "border-gray-700"
                                            }`}
                aria-pressed={active}
              >
                ...
                <div>
                  <h1
                    className={`text-sm md:text-xl text-center font-bold ${
                      active ? "text-[#48372D]" : "text-[#48372D]/80"
                    }`}
                  >
                    {c.title}
                  </h1>
            ...
            {slides.map((s) => (
              ...
              >
                <div className="md:flex justify-center my-3 border-2 border-[#48372D] rounded-[50px] md:rounded-tl-none md:rounded-bl-none w-full transition-all duration-700">
                  <div className="w-full md:w-4/6 bg-[#48372D] rounded-[50px] md:rounded-tl-none md:rounded-bl-none p-6 md:p-10 mb-6 md:mb-0 content-center">
                    <main>
                      <h2 className="text-sm md:text-4xl font-bold text-white">
                        {s.title}
                      </h2>
                      <hr className="my-3 border-dark" />
                      <p className="mt-3 text-xs md:text-lg font-medium text-white leading-relaxed">
      ...
      <div className="max-w-[1440px] mx-auto py-4 animate-pulse">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-3 px-3">
          <div className="md:col-span-3">
            <div className="h-8 md:h-12 w-64 bg-gray-300 rounded"></div>
          </div>

          <div className="hidden md:flex justify-end">
            <div className="h-10 w-56 bg-gray-300 rounded-full"></div>
          </div>
        </div>
        ...
        {/* Description */}
        <div className="px-3">
          <div className="h-4 w-[95%] bg-gray-300 rounded mb-2"></div>
        ...
        <div className="px-3 sm:px-6 my-5">
          <div className="grid grid-cols-2 md:flex justify-center gap-4">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="w-full md:w-1/4 border-2 border-gray-300 p-3 rounded-2xl flex flex-col items-center gap-3"
              >
          ...
          <div className="relative overflow-hidden mt-8">
            <div className="flex">
              {/* Three slides skeleton */}
              {[1, 2, 3].map((i) => (
                <section
                  key={i}
                  className="w-full flex-shrink-0 md:flex md:items-center md:justify-center"
                >
                  <div className="md:flex justify-center my-3 border-2 border-gray-300 rounded-[50px] md:rounded-tl-none md:rounded-bl-none w-full">
                    {/* Left Text Section */}
                    <div className="w-full md:w-4/6 bg-gray-300/40 rounded-[50px] md:rounded-tl-none md:rounded-bl-none p-6 md:p-10 mb-6 md:mb-0">
                      <div className="h-6 md:h-10 w-48 bg-gray-300 rounded mb-3"></div>
                    ...
                    {/* Right Image Section */}
                    <div className="w-full md:w-2/6 p-4 mb-6 md:mb-0 flex items-center justify-center">
                      <div className="rounded-2xl bg-gray-300 w-48 h-48 md:w-64 md:h-64"></div>
                    </div>
                  </div>
                </section>
              ))}
