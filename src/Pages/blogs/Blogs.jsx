    ...
    return (
        <div className="w-full max-w-[1440px] mx-auto overflow-hidden">
            ...
            <div className="my-4 px-2 lg:px-3">
                ...
                <h1 className="text-[#6F4D34] text-[24px] lg:text-[36px] font-bold">
                    {cmsData?.heading || "ArtSays Blog"}
                </h1>

                <h6 className="text-[#E56500] font-semibold text-[14px] lg:text-[16px]">
                        ...
                        {blogs.length > 0 && (
                            <div className="flex justify-center items-center mt-10 space-x-2">
                                ...
                                {Array.from({ length: totalPages }).map((_, index) => (
                                    <button
                                        key={index}
                                        className={`border border-gray-300 w-10 h-10 rounded 
                                            ${currentPage === index + 1
