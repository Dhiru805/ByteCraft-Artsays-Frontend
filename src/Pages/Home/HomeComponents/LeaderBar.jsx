    ...
    <div className="mw-full bg-base mx-auto ">
        <div className="max-w-[1440px] min-h-[408px] flex  gap-[18px] flex-row items-center justify-evenly mx-auto p-[80px] mb-[40px]">
          <div className=" flex-col flex gap-4">
            ...
            <p className="text-[16px] text-black font-normal">Innovating the Future of Investment with Cutting-Edge Technology and Data-Driven Solutions.</p>
          ...
          <div className="flex h-[256px] flex-col items-center justify-center gap-[20px] py-[42px] px-[30px] text-center shadow-md rounded-md ">
            <h3 className="text-[30px] text-orange-200 font-bold font-oswald ">Our Business Productions</h3>
            <p className="text-[16px] text-black font-normal">Use this paragraph to describe what you do. Add information that visitors may find interesting..</p>
          ...
          <div className="flex h-[256px] flex-col items-center justify-center gap-[20px] text-center py-[42px] px-[30px] shadow-md rounded-md ">
            <h3 className="text-[30px] text-orange-200 font-bold text-center  font-oswald">Our approach in Investment</h3>
            <p className="text-[16px] text-black font-normal">Use this paragraph to describe what you do. Add information that visitors may find interesting.</p>
