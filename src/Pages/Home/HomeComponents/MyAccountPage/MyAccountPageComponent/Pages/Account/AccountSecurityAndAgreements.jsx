...
const AccountSecurityAgreements = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-[856px]">
...
//         onChange={handleChange}
//         disabled
//         className={`form-checkbox rounded-full ${formData.twoStepAuthentication ? 'text-blue-600' : 'text-gray-400'}`}
//       />
//       <span>2-Step Authentication (OTP, Email verification, etc.)</span>
//     </li>
//     <li className="flex items-center space-x-2">
...
//         onChange={handleChange}
//         disabled
//         className={`form-checkbox rounded-full ${formData.termsConditionsAgreement ? 'text-blue-600' : 'text-gray-400'}`}
//       />
//       <span>Terms & Conditions Agreement</span>
//     </li>
//     <li className="flex items-center space-x-2">
...
//         onChange={handleChange}
//         disabled
//         className={`form-checkbox rounded-full ${formData.privacyPolicyAgreement ? 'text-blue-600' : 'text-gray-400'}`}
//       />
//       <span>Privacy Policy Agreement</span>
//     </li>
//   </ul>
