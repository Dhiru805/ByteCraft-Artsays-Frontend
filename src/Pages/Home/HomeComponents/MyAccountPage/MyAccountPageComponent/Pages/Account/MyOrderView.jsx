...
const OrderView = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-[#EBEBEB] p-4 md:p-6 relative">
        <h3 className="text-lg font-semibold text-gray-800 mb-4 sm:mb-6">Delivery Status</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl p-4 md:p-6 border border-[#EBEBEB]">
          <h4 className="text-md font-semibold text-gray-800 mb-4">Delivery Details</h4>
      ...
      {/* REVIEW SECTION */}
      <div id="review-section" className="bg-white rounded-2xl p-4 md:p-6 flex flex-col gap-4 border border-[#EBEBEB]">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <h3 className="font-semibold text-gray-800">Rate Your Experience</h3>
          <div className="flex gap-1 text-2xl">
            {[1, 2, 3, 4, 5].map((star) => (
