...
const ContactUsHero = ({ heading, description }) => {
    const mainImage = "/herosectionimg/store.png"; // Using the same as store for consistency or a different one if preferred
    return (
                ...
                <div className="container mx-auto px-6 md:px-12 max-w-[1440px]">
                    <div className="w-full">
                        ...
                        <p className="text-sm sm:text-lg md:text-xl font-medium text-white leading-relaxed opacity-90 line-clamp-3 md:line-clamp-none">
                            {description || "Have a question about a product, need help with your order, or just want to say hello? Reach out and our team will get back to you within 24 hours."}
                        </p>
                    </div>
                </div>
            </div>
