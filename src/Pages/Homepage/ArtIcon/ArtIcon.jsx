...
//               Art Icons
//             </h1>
//             <button className="flex-1 hidden px-6 py-2 font-semibold text-white bg-red-500 rounded-full shadow md:block buy-now">
...
//               </h2>
//               {/* Subtitle */}
//               <p className="mt-3 text-xs font-medium leading-relaxed text-black md:text-base">
...
//                   className="object-contain w-full h-40 sm:h-64"
//                 />
//               </div>
//             </div>
...
//             {/* Button */}
            ...
            //   <div className="absolute transform -translate-x-1/2 bottom-6 left-1/3">
            //     <button
            //       href="#"
            //       className="flex items-center gap-2 px-3 py-2 font-medium font-semibold text-gray-800 transition rounded-full shadow-md bg-white/70 backdrop-blur-md"
            //     >
            //       View Collection
            //       <span className="text-lg text-white">
            //         <ImArrowUpRight2 className="w-8 h-8 p-2 bg-black rounded-full" />
            //       </span>
            //     </button>
            //   </div>
            // </div>
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:!px-0">
        ...
        <div className="flex flex-col justify-between gap-6 mb-8 md:flex-row md:items-end align-items-center">
          <div className="flex flex-col gap-6">
            ...
            <p className="max-w-4xl text-lg font-medium leading-relaxed text-gray-500">
              {data.description}
            </p>
          </div>
          {data.buttonName && (
            <button
              onClick={() => navigate(data.buttonLink || "/celebrity")}
        ...
        <div className="flex gap-3 mt-6 overflow-x-auto sm:grid sm:grid-cols-2 lg:grid-cols-4 snap-x snap-mandatory no-scrollbar" style={{ scrollbarWidth: "none" }}>
          {celebrities.length > 0 ? (
            celebrities.slice(0, 8).map((celebrity, index) => (
              ...
              >
                ...
                <div className="relative overflow-hidden border-gray-100 aspect-square bg-gray-50 border-y">
                  <img
                    src={celebrity.profilePicture || celebrity.image || "/herosectionimg/1.jpg"}
                    alt={celebrity.artistName || ""}
                    className="object-cover w-full h-full transition-transform duration-700 group-hover:scale-105"
                  />
                </div>

                <div className="p-4 mt-auto md:p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-1 md:gap-2">
                      ...
                      <span className="text-[10px] md:text-sm font-bold text-gray-900">
                        {celebrity.yearsActiveInArt || 0}+ Years Active
                      </span>
                    </div>
                    <div className="text-[8px] md:text-[10px] font-bold text-[#6F4D34] bg-[#6F4D34]/5 px-2 md:px-3 py-1 rounded-full uppercase tracking-wider">
                      Featured
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-[#6F4D34] text-white hover:!text-[#6F4D34] py-2 md:py-3 border border-gray-100 rounded-xl font-bold hover:bg-[#ffffff] transition-colors shadow-sm text-xs md:text-base"
                  >
                    View Collection
                    <ImArrowUpRight2 size={12} className="md:w-[14px] md:h-[14px]" />
                  </button>
                </div>
              </div>
            ))
          ) : (
            <div>No celebrities available</div>
          )}
        </div>
      </div>
    </div>
