    ...
    <div className="w-full font-[poppins]">
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({ "@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{ "@type": "ListItem", "position": 1, "name": "Home", "item": "https://artsays.in/" }, { "@type": "ListItem", "position": 2, "name": "Licensing Partner", "item": "https://artsays.in/licensing-partner" }] })}
        </script>
      </Helmet>
      <nav aria-label="breadcrumb" className="max-w-[1440px] mx-auto px-4 md:px-8 flex items-center gap-2 text-sm text-gray-500 py-3">
        ...
        <span className="text-[#6F4D34] font-semibold" aria-current="page">Licensing Partner</span>
      </nav>
