                    ...
                    <aside className="w-full lg:w-[300px] shrink-0">
                        <div className="sticky top-6 space-y-4">
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                                <h2 className="text-xl font-bold text-gray-900 mb-1">Why Artsays?</h2>
                                <nav className="flex items-center text-sm text-gray-500 mt-2">
                                    <a href="/" className="hover:text-[#6F4D34] transition-colors">Home</a>
                                    <ChevronRight size={14} className="mx-2" />
                                    <span className="text-[#6F4D34] font-medium">Why Buy From Artsays</span>
                                </nav>
                            </div>

                            <SidebarCard title="Our Mission" icon={Info}>
                                <p className="text-sm text-gray-600 leading-relaxed">
                                    At Artsays, we are dedicated to connecting art lovers with unique masterpieces while supporting the creative community.
                                </p>
                            </SidebarCard>

                            <SidebarCard title="Help Center" icon={HelpCircle}>
                            ...
                            <div className="bg-[#6F4D34] p-6 rounded-2xl shadow-xl text-white relative overflow-hidden group">
                                <div className="relative z-10">
                                    ...
                                    <p className="text-sm opacity-90 mb-4">Experience the best of the art world.</p>
                                    <button className="w-full py-3 bg-white text-[#6F4D34] rounded-xl font-bold text-sm hover:bg-gray-100 transition-colors" onClick={() => window.location.href = '/register'}>
                                        Join Artsays Today
                                    </button>
                                </div>
