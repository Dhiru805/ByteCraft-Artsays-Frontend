...
const AgreementContent = ({ selectedAgreementId }) => {
  ...
  useEffect(() => {
    ...
    const fetchAgreement = async () => {
      setLoading(true);
      try {
        const res = await axios.get(`/api/getArtistSellerAgreement/${selectedAgreementId}`);
    ...
    return (
      <div className="bg-white p-12 rounded-3xl shadow-sm border border-gray-100 text-center">
        <p className="text-gray-500 font-medium">
          Select an agreement from the sidebar to view its details.
        </p>
      </div>
    );
  }
  ...
  return (
    <div
      ...
      className="bg-white p-6 rounded-[32px] shadow-sm border border-gray-100 animate-fade-in printable-area"
    >
      ...
      <style>
        {`
          .agreement-rich-text h1, .agreement-rich-text h2, .agreement-rich-text h3 {
            font-weight: 800;
            color: #111827;
            margin-top: 2.5rem;
          ...
          .agreement-rich-text h1 { font-size: 2.25rem; }
          .agreement-rich-text h2 { font-size: 1.875rem; border-bottom: 2px solid #f3f4f6; padding-bottom: 0.75rem; }
          .agreement-rich-text h3 { font-size: 1.5rem; }

          .agreement-rich-text p {
          ...
          .agreement-rich-text ul, .agreement-rich-text ol {
            margin-bottom: 2rem;
            padding-left: 1.5rem;
            color: #374151;
          }

          .agreement-rich-text li {
            margin-bottom: 0.75rem;
            line-height: 1.6;
          }

          .agreement-rich-text strong {
            color: #111827;
            font-weight: 700;
          }

          .agreement-rich-text a {
            color: #6F4D34;
          ...
          .agreement-rich-text a:hover {
            color: #4a3423;
          }

          .agreement-rich-text blockquote {
