...
import { Search, ChevronRight, HelpCircle, TrendingUp, ShieldCheck } from "lucide-react";
                    ...
                    <aside className="w-full lg:w-[300px] shrink-0">
                        <div className="sticky top-6 space-y-4">
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                                <h2 className="text-xl font-bold text-gray-900 mb-1">Reseller Guide</h2>
                                <p className="text-sm text-gray-500">Step-by-step reselling process</p>
                                <nav className="flex items-center text-sm text-gray-500 mt-2">
                                    <a href="/" className="hover:text-[#6F4D34] transition-colors">Home</a>
                                    <ChevronRight size={14} className="mx-2" />
                                    <span className="text-[#6F4D34] font-medium">How to Resell</span>
                                </nav>
                            </div>

                            <SidebarCard title="Why Resell on Artsays?" icon={TrendingUp}>
                                <p className="text-sm text-gray-600 leading-relaxed">
                                    Maximize your art investments by reselling to a global community of collectors. Our platform ensures a secure and transparent secondary market.
                                </p>
                            </SidebarCard>

                            <SidebarCard title="Reseller Benefits" icon={ShieldCheck}>
                                <ul className="space-y-2">
                                    <li className="flex items-start gap-2 text-sm text-gray-600">
                                        <div className="w-1.5 h-1.5 rounded-full bg-[#6F4D34] mt-1.5 shrink-0" />
                                        Verified authenticity tracking
                                    </li>
                                    <li className="flex items-start gap-2 text-sm text-gray-600">
                                        <div className="w-1.5 h-1.5 rounded-full bg-[#6F4D34] mt-1.5 shrink-0" />
                                        Secure resale transactions
                                    </li>
                                    <li className="flex items-start gap-2 text-sm text-gray-600">
                                        <div className="w-1.5 h-1.5 rounded-full bg-[#6F4D34] mt-1.5 shrink-0" />
                            ...
                            <SidebarCard title="Need Help?" icon={HelpCircle}>
                                <div className="space-y-3">
                                    ...
                                    <button className="w-full flex items-center justify-between p-3 rounded-xl bg-gray-50 hover:bg-[#6F4D34]/5 text-gray-700 hover:text-[#6F4D34] transition-all group" onClick={() => window.location.href = '/faq'}>
                                        <span className="text-sm font-semibold">Reseller FAQs</span>
                                        <ChevronRight size={16} className="group-hover:translate-x-1 transition-transform" />
                                    </button>
                                </div>
                            </SidebarCard>
                            ...
                            <div className="bg-[#6F4D34] p-6 rounded-2xl shadow-xl text-white relative overflow-hidden group">
                                <div className="relative z-10">
                                    <h3 className="text-xl font-bold mb-2">Ready to Resell?</h3>
                                    <p className="text-sm opacity-90 mb-4">Start trading your collection on the Artsays marketplace.</p>
                                    <button 
                    ...
                    <main className="flex-grow space-y-3">
                        ...
                        <div className="space-y-3">
                            <div className="relative group">
                                <input
                                    type="text"
                                    placeholder="Search reseller topics..."
                                    value={searchTerm}
                                ...
                                filteredArticles.map((article, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="w-full lg:w-3/5 space-y-3">
                                            ...
                                            <p className="text-base md:text-lg text-gray-600 leading-relaxed font-medium whitespace-pre-wrap">
