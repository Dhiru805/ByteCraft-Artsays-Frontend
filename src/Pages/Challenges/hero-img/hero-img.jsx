...
const HeroImgChallenges = () => {
    const mainImage = "/banners/commission.png"; // Using the same banner as commission for design consistency as requested
    return (
        <div className="relative w-full h-[300px] sm:h-[250px] md:h-[300px] overflow-hidden flex items-center justify-center font-[poppins]">
            <img
                src={mainImage}
                alt="Challenges Hero"
                ...
                <div className="container mx-auto px-6 md:px-12 max-w-[1440px]">
                    <div className="w-full">
                        ...
                        <p className="text-sm sm:text-lg md:text-xl font-medium text-white leading-relaxed opacity-90 line-clamp-3 md:line-clamp-none">
                            Participate in exciting competitions, win amazing prizes, and gain recognition in the creative community.
                        </p>
                    </div>
                </div>
            </div>
...
export default HeroImgChallenges;
