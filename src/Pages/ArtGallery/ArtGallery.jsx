  ...
  return (
    <div className="w-full font-[poppins]">
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "Art Gallery", "item": "https://artsays.in/art-gallery" }
            ]
          })}
        </script>
      </Helmet>
      ...
      <nav aria-label="breadcrumb" className="max-w-[1440px] mx-auto px-4 md:px-8 flex items-center gap-2 text-sm text-gray-500 py-3">
        ...
        <span className="text-[#6F4D34] font-semibold" aria-current="page">Art Gallery</span>
      </nav>
      <ArtGalleryContent/>
