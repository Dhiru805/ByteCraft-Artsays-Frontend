...
//         </div>
//        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 px-3 my-5">
//   {celebrityProducts.length === 0 ? (
//     <p className="text-center text-gray-600 col-span-full">
//       No artworks found for this celebrity.
//     </p>
//   ) : (
//     celebrityProducts.map((product) => (
//       <div
//         key={product._id}
//         className="mx-auto product-card border rounded-2xl overflow-hidden bg-white"
//       >
//         {/* Premium Label */}
//         <div className="relative p-img">
//           {product.editionType && (
...
//         {/* BUTTONS */}
//         <div className="p-3 product-button">
//           <div className="flex justify-between gap-3">
//             <button className="flex-1 border border-dark rounded-full py-2 font-semibold">
//               Add to Cart
//             </button>
//             <button className="flex-1 bg-red-500 text-white py-2 rounded-full font-semibold shadow">
//               Buy Now
//             </button>
//           </div>
//         </div>
