      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 py-8 space-y-12">
        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          <div className="w-full md:w-auto">
            <nav className="flex items-center px-4 py-2 text-sm text-gray-500 bg-white border border-gray-100 rounded-full shadow-sm w-fit">
          ...
          <div className="relative w-full group md:w-1/2 lg:w-1/3">
            <input
              type="text"
              placeholder="Search for roles, categories, or keywords..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full p-4 pl-12 bg-white border border-gray-200 rounded-full shadow-sm focus:outline-none focus:ring-4 focus:ring-[#6F4D34]/5 focus:border-[#6F4D34] transition-all text-dark placeholder:text-gray-400"
            />
          </div>
        </div>
