...
const HeroImgCareer = () => {
    const mainImage = "/herosectionimg/store.png";
    return (
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#000000]/90 to-transparent flex items-center">
                <div className="container mx-auto px-6 md:px-12 max-w-[1440px]">
                    <div className="w-full">
                        ...
                        <p className="text-sm sm:text-lg md:text-xl font-medium text-white leading-relaxed opacity-90 line-clamp-3 md:line-clamp-none max-w-3xl">
                            Help us shape the future of art and technology by joining a world-class team of creators and innovators.
                        </p>
                    </div>
                </div>
            </div>
