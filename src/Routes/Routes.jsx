...
import CheckOutTemplate from "../Pages/Home/HomeComponents/MyAccountPage/MyAccountPageComponent/Pages/Account/MyCart/CheckOut copy";
...
import ProductFetchView from "../Component/ProductFetchView/ProductFetchView";
...
import ArtistNotificationsPage from "../Component/Dashboard/ArtistDashbooard/Notifications/ArtistNotificationsPage";
      ...
      <Route path="/" element={<WebsiteWrapper />}>
        ...
        <Route element={<PrivateRoute allowedRoles={["Buyer", "Artist", "Seller", "Super-Admin"]} blockCreatedAdmins />}>
          ...
          <Route
            ...
            element={<SharePost />}
          />
          {/* <Route path="/artsays-community/share-profile/:viewedUserId" element={<ShareProfile />} /> */}

          <Route
            path="/artsays-community/single-post/:postId"
            element={<SinglePost />}
          />
          ...
          <Route
            path="/artsays-community/profile/product-view"
            element={<ProductViewing />}
          />
          <Route
            path="/artsays-community/profile/suggestion"
            element={<SuggestedProfile />}
          />
          <Route
            path="/artsays-community/profile/promote-profile"
