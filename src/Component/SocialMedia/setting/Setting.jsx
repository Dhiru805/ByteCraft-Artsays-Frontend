      ...
      h-[30vh] flex flex-col justify-between items-center gap-4"
                ...
                >
                  ...
                  <div className="flex items-center justify-between w-full px-6">
                    <button
                      className="bg-gray-100 text-[#000000] text-lg px-4 py-2 rounded-lg"
                      onClick={() => setDeleteAccount(false)}
                    >
                      Cancel
                    </button>
                    <button
                      className="bg-red-500 text-gray-100 text-lg px-4 py-2 rounded-lg"
            ...
            <button
              className="w-full bg-[#4f3823] text-white text-2xl font-semibold rounded-xl py-3 mx-8 mx-auto"
                      ...
                      {showPerksDropdown && (
                        <div className="absolute mt-1 w-full bg-white border border-gray-300 rounded-md shadow-md max-h-48 overflow-y-auto z-50">
                          {perks.map((perk) => (
                            <label
                              key={perk._id}
                              className="flex items-center gap-2 text-sm px-3 py-2 hover:bg-gray-100"
                            >
                              <input
                                type="checkbox"
                ...
                <div className="w-full flex flex-col gap-3">
                  {profile?.blocked?.map((item) => (
                    ...
                    >
                      ...
                      <button
                        className="px-3 py-1.5 bg-[#F4F6F8] text-[14px] font-bold text-[#48372D]"
