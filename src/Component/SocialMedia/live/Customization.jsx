...
const Customization = () => {
  ...
  const handleParticipantModeChange = (key) => {
    setFormData((prev) => ({
      ...prev,
      customization: {
        ...prev.customization,
        participantModes: {
          ...
          liveCommentary: key === "liveCommentary",
        },
      },
    }));
  };
  ...
  return (
    <div className="w-full sm:mx-auto sm:border-[0.5px] sm:border-[#48372D] mt-6 bg-white flex flex-col sm:rounded-t-xl sm:rounded-b-xl">
      {/* Header Tabs */}
      ...
      <main className="flex-1 w-full sm:mx-auto">
        {activeTab === "details" && (
          <div className="flex flex-col gap-4 p-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative p-2 rounded-xl border-[1px] border-[#48372D]">
                <div className="flex flex-col gap-2 text-[18px] ml-2 font-bold">Enter your tags
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="w-1/2 relative">
                ...
                {showSearch && (
                  <div
                    className="absolute top-full left-0 w-full mt-1 bg-white border-[1px] border-[#48372D] rounded-xl max-h-60 overflow-y-auto z-[999]"
              ...
              <div className="flex flex-col gap-2 text-[#48372D] text-[16px] ml-3">
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={() => handleParticipantModeChange("anyone")}
                    className="accent-[#48372D]"
                  />
                  <span>Anyone</span>
                </label>
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={() => handleParticipantModeChange("subscribers")}
                    className="accent-[#48372D]"
                  />
                ...
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={() => handleParticipantModeChange("liveCommentary")}
                    className="accent-[#48372D]"
                  />
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex justify-center gap-6">
                  <button
                    ...
                    className={`w-14 h-14 rounded-full flex items-center justify-center transition-colors ${isCameraOn
                  ...
                  <button
                    onClick={toggleMic}
                    className={`w-14 h-14 rounded-full flex items-center justify-center transition-colors ${isMicOn
                        ? 'bg-[#48372D] text-white'
                        : 'bg-red-500 text-white'
                      }`}
      ...
      <div className="p-3 flex justify-between bg-white rounded-b-xl sm:border-t sm:border-[#48372D] relative">
        ...
        <button
          className={`px-6 py-2 rounded-md ${activeTab === "preview" && permissionStatus !== 'granted'
