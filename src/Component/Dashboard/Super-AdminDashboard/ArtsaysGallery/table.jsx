...
function Curations() {
  ...
  // ✅ FIXED: Only update UI after ConfirmationDialog deletes successfully
  // ConfirmationDialog handles the API call, this just updates the state
  const handleDeleteConfirmed = (id) => {
    // Remove from table without refresh
    setCurationsData((prev) => prev.filter((c) => c._id !== id));
