...
//     try {
//       const response = await getAPI("/api/affiliate");
...
//     try {
//       await axiosInstance.delete(`/api/affiliate/delete/${id}`);
...
//             <h2>Affiliate Pages</h2>
//           </div>
//           <div className="col-lg-6 col-md-6 col-sm-12">
//             <div className="d-flex flex-row-reverse">
//               <button
//                 className="btn btn-secondary"
//                 onClick={() => navigate("/super-admin/affiliate/create")}
//               >
...
//                             title="Edit"
//                             onClick={() =>
//                               navigate("/super-admin/affiliate/update", {
//                                 state: { page },
//                               })
//                             }
//                           >
...
const AffiliateTable = () => {
  ...
  const handleSEOSubmit = async () => {
    try {
      ...
      if (seoData._id) {
        await axiosInstance.put(`/api/affiliate/updateSEO/${seoData._id}`, formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
        toast.success("SEO metadata updated successfully.");
      } else {
        await axiosInstance.post("/api/affiliate/createSEO", formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
                      ...
                      <tr key={page._id}>
                        ...
                        <td>
                          <button
                            className="btn btn-outline-info btn-sm mr-1"
                            onClick={() =>
                              navigate("/super-admin/affiliate/update", { state: { page } })
                            }
                          >
                            <i className="fa fa-pencil"></i>
                          </button>
