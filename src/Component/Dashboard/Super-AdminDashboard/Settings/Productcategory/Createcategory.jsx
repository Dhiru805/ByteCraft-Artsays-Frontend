              ...
              {categoryRows.map((row, index) => (
                <div className="row mb-3" key={index}>
                  ...
                  <div className="col-lg-1 col-md-2 col-sm-2 w-sm:space-y-2 d-flex align-items-end w-4 h-4">
                    {!showOtherFields && (
                      index === 0 ? (
                        <button type="button" className="btn btn-success w-100" style={{ width: '40px', height: '40px', fontSize: '20px' }} onClick={addRow}>+</button>
                      ) : (
                        <button type="button" className="btn btn-danger w-100" style={{ width: '40px', height: '40px', fontSize: '20px' }} onClick={() => removeRow(index)}>-</button>
                      )
                    )}
                  </div>
