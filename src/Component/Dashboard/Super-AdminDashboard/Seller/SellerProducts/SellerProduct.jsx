...
const ProductRequest = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const result = await getAPI("http://localhost:3001/api/getsellerproduct", {}, true, false);
                                    ...
                                    <tbody>
                                        {displayedProducts.map((product, index) => (
                                            <tr key={product._id}>
                                                ...
                                                <td>
                                                    <button className="btn btn-sm btn-outline-info mr-2" onClick={() => navigate(`/${userType}/Dashboard/sellerproduct/sellerproductdetails/${product._id}`)}>
