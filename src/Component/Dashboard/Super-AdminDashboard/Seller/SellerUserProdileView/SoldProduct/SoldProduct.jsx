...
//                                                 <td>
//                                                     <button className="btn btn-sm btn-outline-info mr-2" onClick={() => navigate(`/${userType}/Dashboard/sellermanagetable/sellerprofileview/${userId}/soldproductdetails/${product.productId}`, { state: { userId } })}>
...
//     const userIdFromState = location.state?.seller?._id || location.state?.userId;
//     const resolvedUserId = userId || userIdFromState || sellerIdFromParams;

//     useEffect(() => {
//         const fetchProducts = async () => {
//             try {
//                 const result = await getAPI(`/api/orders/seller/${resolvedUserId}`, {}, true, false);
//                 console.log("Seller Sold Orders:", result);
...
//                 } else {
//                     console.error("Invalid format from Seller order API.");
//                     setProducts([]);
//                 }
//             } catch (err) {
