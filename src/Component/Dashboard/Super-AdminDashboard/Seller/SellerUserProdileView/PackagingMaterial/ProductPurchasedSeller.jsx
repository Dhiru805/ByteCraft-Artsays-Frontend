...
const ProductPurchased = ({ userId }) => {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                const url = `/api/getseller-purchasedproductbyid/${userId}`;
    ...
    const filteredProducts = products.filter(product => {
        ...
        return (
            ...
            product.user?.lastName?.toLowerCase().includes(searchTerm.toLowerCase())
        );
    });
                                            ...
                                            {displayedProducts.map((product, index) => {
                                                ...
                                                return (
                                                    <tr key={product._id}>
                                                        ...
                                                        <td>
                                                            {productData && (
                                                                <button className="btn btn-sm btn-outline-info mr-2" onClick={() => navigate(`/${userType}/Dashboard/sellermanagetable/sellerprofileview/${userId}/packagingproductdetails/${product.product._id}`, { state: { userId } })}>
