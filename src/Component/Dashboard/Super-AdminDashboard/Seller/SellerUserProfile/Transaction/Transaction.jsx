...
fetchProducts();
   ...
   const filteredProducts = products.filter(product => {
        ...
        return (
            productData?.userId?.name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
            productData?.userId?.lastName?.toLowerCase().includes(searchTerm.toLowerCase())
        );
    });
                                        ...
                                        {displayedProducts.map((product, index) => {
                                            ...
                                            return (
                                                <tr key={product._id}>
                                                    ...
                                                    <td>
                                                        {productData && (
                                                            <button className="btn btn-sm btn-outline-info mr-2" onClick={() => navigate(`/${userType}/Dashboard/sellermanagetable/sellerprofile/${userId}/transactionproductdetails/${product._id}`, { state: { userId } })}>
