...
function AllProduct() {
    ...
    const handleDeleteConfirmed = () => {
        setProducts(null); 
        setIsDeleteDialogOpen(false);
        navigate(`/${userType}/Dashboard/sellermanagetable/sellerprofile/${userId}`);
    };
    ...
    const handleEdit = (productId) => {
        ...
        navigate(`/${userType}/Dashboard/sellermanagetable/sellerprofile/${userId}/sellerproductdetails/editprdouct/${productId}`,{ state: { userId } });
      };
