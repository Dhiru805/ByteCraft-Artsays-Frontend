                        ...
                        <ul className="breadcrumb">
                            <li className="breadcrumb-item">
                             ...
                             <li className="breadcrumb-item active">
                              ...
                              <li className="breadcrumb-item active">
                              <Link to={`/${userType}/Dashboard/sellermanagetable/sellerprofile/${userId}`} >Seller Profile</Link></li>
                              <li className="breadcrumb-item active">
                              <Link to={`/${userType}/Dashboard/sellermanagetable/sellerprofile/${userId}/sellerproductdetails/${productId}`} >
                              Seller Product Details</Link></li>
                            <li className="breadcrumb-item ">Seller Edit Product</li>
                        </ul>
                    </div>
                </div>
            </div>
