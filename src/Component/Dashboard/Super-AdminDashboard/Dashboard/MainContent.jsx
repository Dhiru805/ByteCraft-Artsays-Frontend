                            ...
                            <ul className="header-dropdown">
                                ...
                                <li className="dropdown">
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-right">
                                        <li><a href="#!" onClick={(e) => e.preventDefault()}>Action</a></li>
                                        <li><a href="#!" onClick={(e) => e.preventDefault()}>Another Action</a></li>
                                        <li><a href="#!" onClick={(e) => e.preventDefault()}>Something else</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
