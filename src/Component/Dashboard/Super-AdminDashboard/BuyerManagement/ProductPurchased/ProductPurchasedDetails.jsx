        ...
        if (result.data && result.data.data) {
          ...
          productData.forEach((product) => {
            ...
            if (productInfo?.mainImage) {
              initialSelectedImages[productInfo._id] = formatImage(productInfo.mainImage);
            }
          });
        ...
        <div className="col-lg-6 col-md-6 col-sm-12">
          ...
          <ul className="breadcrumb">
            ...
            <li className="breadcrumb-item active">
              <Link to={`/${userType}/Dashboard/buyerproductpurchased`}>
                Buyer Product Purchased
              </Link>
            </li>
                  ...
                  <div className="preview col-lg-4 col-md-12">
                    <div className="preview-pic tab-content">
                      <div className="tab-pane active">
                        <img
                          src={
                            selectedImages[productData?._id] ||
                            formatImage(productData?.mainImage) ||
                            "/default-image.jpg"
                          }
                          className="img-fluid"
                          style={{
                    ...
                    <div className="d-flex flex-wrap justify-content-start">
                      {[
                        formatImage(productData.mainImage),
                        ...(productData.otherImages || []).slice(0, 4).map(img => formatImage(img)),
                      ].map((image, imgIndex) => (
                        <div key={imgIndex} style={{ margin: "5px" }}>
                          <img
                            ...
                            onClick={() =>
                              handleImageClick(productData._id, image)
                            }
                            onMouseEnter={(e) => {
