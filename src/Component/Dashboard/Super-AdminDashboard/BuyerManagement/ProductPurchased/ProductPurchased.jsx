...
const ProductRequest = () => {
  ...
  const filteredProducts = products.filter((product) => {
    const fullName =
      `${product.buyer.name} ${product.buyer.lastName}`.toLowerCase();
                          ...
                          <td>
                            {productData && (
                              <button
                                ...
                                onClick={() =>
                                  navigate(
                                    `/${userType}/Dashboard/buyerproductpurchased/productpurchaseddetails/${product._id}`
                                  )
                                }
                              >
