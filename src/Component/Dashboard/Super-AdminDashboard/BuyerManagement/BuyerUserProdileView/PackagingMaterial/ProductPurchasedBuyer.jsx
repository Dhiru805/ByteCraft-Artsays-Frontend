...
const ProductPurchased = ({userId}) => {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                const url = `/api/getbuyer-purchasedproductbyid/${userId}`;
                                        ...
                                        {displayedProducts.map((product, index) => {
                                            ...
                                            return (
                                                <tr key={product._id}>
                                                    ...
                                                    <td>
                                                        {productData && (
                                                           <button className="btn btn-sm btn-outline-info mr-2" onClick={() => navigate(`/${userType}/Dashboard/buyermanagetable/buyerprofileview/${userId}/packagingproductdetails/${product.product._id}`, { state: { userId } })}>
