...
const Transaction = ({userId}) => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const result = await getAPI(`/api/gettransactionbybuyerid/${userId}`, {}, true, false);
...
const filteredProducts = products.filter(product => {
        ...
        return (
            product.transactionId?.toLowerCase().includes(searchTerm.toLowerCase()) ||
                                                ...
                                                <tr key={product._id}>
                                                    ...
                                                    <td>
                                                        {productData && (
                                                            ...
                                                            onClick={() => navigate(`/${userType}/Dashboard/buyermanagetable/buyerprofileview/${userId}/transactionproductdetails/${product._id}`,{ state: { userId } })}>
