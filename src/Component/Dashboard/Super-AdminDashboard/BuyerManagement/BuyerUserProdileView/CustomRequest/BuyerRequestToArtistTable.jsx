...
const BASE_URL = process.env.REACT_APP_API_URL_FOR_IMAGE;
    ...
    const filteredRequests = buyerRequests.filter(request =>
        ...
        request.Artist?.id?.name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
        request.Artist?.id?.lastName?.toLowerCase().includes(searchTerm.toLowerCase())
    );
                                                    ...
                                                    <td>
                                                        <button
                                                            ...
                                                            onClick={() => {
                                                                ...
                                                                navigate(`/${userType}/Dashboard/buyermanagetable/buyerprofileview/${userId}/viewrequesttoartist/${request._id}`, {
