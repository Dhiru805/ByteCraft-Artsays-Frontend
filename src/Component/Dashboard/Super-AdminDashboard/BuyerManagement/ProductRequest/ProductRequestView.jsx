...
function AllProduct() {
  ...
  const [selectedProductRequestToDelete, setSelectedProductRequestToDelete] =
    useState(null);
    ...
    const fetchProduct = async () => {
      ...
      try {
        const result = await getAPI(
          `/api/getbuyerproductbyid/${productId}`,
          {},
          true,
          false
        );
  ...
  const handleDeleteConfirmed = () => {
    setProducts(
      products.filter((p) => p._id !== selectedProductRequestToDelete._id)
    );
    setIsDeleteDialogOpen(false);
  ...
  const handleEdit = (productId, userId) => {
    ...
    navigate(
      `/${userType}/Dashboard/buyerproductrequest/productview/editproduct/${userId}`
    );
  };
          ...
          <div className="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul className="breadcrumb">
              ...
              <li className="breadcrumb-item active">
                <Link to={`/${userType}/Dashboard/buyerproductrequest`}>
                    ...
                    {product.userId && (
                      <>
                        <button
                          ...
                          onClick={() =>
                            handleEdit(product._id, product.userId?._id)
                          }
                        >
                          Edit
                        </button>
