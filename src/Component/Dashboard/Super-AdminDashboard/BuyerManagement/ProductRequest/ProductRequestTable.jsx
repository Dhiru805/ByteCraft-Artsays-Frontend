...
const ProductRequest = () => {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    const fullName = `${buyer?.name || ""} ${buyer?.lastName || ""}`
      .trim()
      .toLowerCase();
                ...
                <table className="table table-hover">
                  ...
                  <tbody>
                    {displayedProducts.map((product, index) => {
                      const buyer = product?.buyerId || product?.userId || {};
                      const buyerId =
                        product?.userId?._id || product?._id || "";
                            ...
                            <button
                              ...
                              onClick={() => {
                                ...
                                if (!buyerId) {
                                  ...
                                  toast.error(
                                    "Cannot navigate: ID is missing."
                                  );
                                  return;
                                }
                                navigate(
                                  `/super-admin/buyer/resellproduct/productview/${buyerId}`
                                );
                              }}
                            >
