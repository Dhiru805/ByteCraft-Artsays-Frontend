...
const totalPages = Math.ceil(buyers.length / productsPerPage); 
  const displayedBuyers = buyers.slice( 
              ...
              <div className="body">
                <div className="table-responsive">
                  <table className="table table-hover js-basic-example dataTable table-custom m-b-0 c_list">
                    ...
                    Showing {(currentPage - 1) * productsPerPage + 1} to {Math.min(currentPage * productsPerPage, buyers.length)} of {buyers.length} entries
                                </span>
