                  ...
                  <tbody>
                    {displayedProducts.map((product, index) => (
                      <tr key={product.productId}>
                        ...
                        {/* SAFE DISPLAY */}
                        <td>{product?.buyerName?.trim() || "N/A"}</td>
                        ...
                        <td>
                          <button
                            ...
                            onClick={() =>
                              navigate(
                                `/${userType}/Dashboard/buyersoldproduct/soldproductdetails/${product.productId}`
                              )
                            }
                          >
                            <i className="fa fa-eye"></i>
