            ...
            <div className="d-flex flex-row-reverse">
              <div className="page_action d-flex">
                <button
                  ...
                  onClick={() => navigate("/super-admin/partner/create")}
                >
                  <i className="fa fa-plus"></i> Add Partner Page
                </button>
              </div>
            </div>
          </div>
                ...
                <table className="table table-hover text-center">
                  ...
                  <tbody>
                      ...
                      <tr key={page._id}>
                        ...
                        <td>
                          <button
                            ...
                            onClick={() =>
                              navigate("/super-admin/partner/edit", {
                                state: { page },
                              })
                            }
                          >
                    ...
                    {displayedPages.length === 0 && (
                      <tr>
                        <td colSpan={8}>No partner pages found.</td>
                      </tr>
                    )}
                  </tbody>
                </table>
