...
const Card = () => {
  ...
  const fetchMaterials = async () => {
    try {
      ...
      const res = await getAPI(
        `/api/packaging-material-setting/material-card/${userId}`
      );
  ...
  const openEditModal = (mat) => {
    ...
    setImagePreview(
      mat.materialCardImage
        ? getImageUrl(mat.materialCardImage.replace(/\\/g, "/"))
        : "/placeholder.jpg"
    );
    setEditId(mat._id);
    setShowPopUp(true);
  ...
  const filteredItems = materials.filter((mat) =>
    mat.materialCard?.toLowerCase().includes(searchTerm.toLowerCase())
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await postAPI(
        "/api/packaging-material-setting/material-card/create",
        formData
      );
      fetchMaterials();
      setShowPopUp(false);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await putAPI(
        `/api/packaging-material-setting/material-card/update/${editId}`,
        formData
      );
      fetchMaterials();
      setShowPopUp(false);
                              ...
                              <div>
                                ...
                                <div className="form-group mt-3">
                                  ...
                                  {viewData?.materialCardImage && (
                                    <div className="mt-2">
                                      <img
                                        src={getImageUrl(viewData.materialCardImage.replace(/\\/g,"/"))}
                                        alt="Preview"
                              ...
                              >
                                <div className="form-group">
                                  ...
                                  <input
                                    ...
                                    value={materialCard}
                                    onChange={(e) =>
                                      setMaterialCard(e.target.value)
                                    }
                                    required
                                  />
                                </div>
