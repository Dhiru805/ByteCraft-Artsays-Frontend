...
const Vouchers = () => {
  ...
  const fetchMaterials = async () => {
    ...
    try {
      ...
      const res = await getAPI(
        `/api/packaging-material-setting/material-vouchers/${userId}`
      );
  ...
  const filteredItems = materials.filter((mat) =>
    mat.materialVouchers?.toLowerCase().includes(searchTerm.toLowerCase())
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await postAPI(
        "/api/packaging-material-setting/material-vouchers/create",
        formData
      );
      fetchMaterials();
      setShowPopUp(false);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await putAPI(
        `/api/packaging-material-setting/material-vouchers/update/${editId}`,
        formData
      );
      fetchMaterials();
      setShowPopUp(false);
                        ...
                        <div className="modal-content">
                          <div className="modal-header">
                            <h5 className="modal-title">
                              {viewMode
                                ? "View Material Vouchers"
                                : editMode
                                ? "Update Material Vouchers"
                                : "Create Material Vouchers"}
                            </h5>
                            <button
                              type="button"
                              className="close"
                              ...
                              >
                                <div className="form-group">
                                  ...
                                  <input
                                    ...
                                    onChange={(e) =>
                                      setMaterialVouchers(e.target.value)
                                    }
                                    required
                                  />
                                </div>
