  ...
  const fetchMaterials = async () => {
    ...
    try {
      ...
      const res = await getAPI(
        `/api/packaging-material-setting/material-stamp/${userId}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await postAPI(
        "/api/packaging-material-setting/material-stamp/create",
        formData
      );
      fetchMaterials();
      setShowPopUp(false);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await putAPI(
        `/api/packaging-material-setting/material-stamp/update/${editId}`,
        formData
      );
      fetchMaterials();
      setShowPopUp(false);
                          ...
                          <div className="modal-header">
                            <h5 className="modal-title">
                              {viewMode
                                ? "View Material Stamp"
                                : editMode
                                ? "Update Material Stamp"
                                : "Create Material Stamp"}
                            </h5>
                            <button
                              type="button"
                              className="close"
                              ...
                              >
                                <div className="form-group">
                                  ...
                                  <input
                                    ...
                                    value={materialStamp}
                                    onChange={(e) =>
                                      setMaterialStamp(e.target.value)
                                    }
                                    required
                                  />
                                </div>
