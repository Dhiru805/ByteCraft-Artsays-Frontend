...
//     try {
//       const response = await getAPI("/api/howtobuy");
//       const data = Array.isArray(response.data.data) ? response.data.data : [];
//       setPages(data);
//     } catch (error) {
//       console.error("Error fetching How To Buy pages:", error);
...
//                 onClick={() => navigate("/super-admin/how-to-buy/create")}
//               >
...
//                             title="Edit"
//                             onClick={() =>
//                               navigate("/super-admin/how-to-buy/update", {
//                                 state: { page },
//                               })
//                             }
//                           >
...
const HowToBuyTable = () => {
  ...
  const fetchSEOMetadata = async () => {
    try {
      const response = await axiosInstance.get("/api/howtobuy/getEO");
  ...
  const handleSEOSubmit = async () => {
    try {
      ...
      if (seoData._id) {
        await axiosInstance.put(`/api/howtobuy/updateSEO/${seoData._id}`, formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
        toast.success("SEO metadata updated successfully.");
      } else {
        await axiosInstance.post("/api/howtobuy/createSEO", formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
                      ...
                      <tr key={page._id}>
                        ...
                        <td>
                          <button
                            ...
                            title="Edit"
                            onClick={() =>
                              navigate("/super-admin/how-to-buy/update", { state: { page } })
                            }
                          >
                            <i className="fa fa-pencil"></i>
                          </button>
