                        ...
                        <td>
                          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                            ...
                            {product.status?.toLowerCase() !== "closed" && (
                              <>
                                {/* Edit */}
                                <button type="button" className="btn btn-outline-info btn-sm" title="Edit" onClick={() => navigate("/super-admin/advertise/sponser", { state: { campaign: product } })}>
                                  <i className="fa fa-pencil"></i>
                                </button>

                                {/* Delete */}
                                <button type="button" className="btn btn-outline-danger btn-sm" title="Delete" onClick={() => openDeleteDialog(product)}>
        ...
        <div onClick={() => setViewCampaign(null)} style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.6)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1050 }}>
          <div onClick={(e) => e.stopPropagation()} style={{ backgroundColor: '#fff', borderRadius: '12px', width: '90%', maxWidth: '700px', maxHeight: '85vh', overflow: 'auto', padding: '24px', position: 'relative' }}>
            ...
            <div className="row mb-3">
              ...
              <div className="col-sm-6">
                <strong>User:</strong> {viewCampaign.userId?.name} {viewCampaign.userId?.lastName}
              </div>
            </div>
            ...
            <div className="row mb-3">
              <div className="col-sm-6"><strong>Country:</strong> {viewCampaign.country || 'N/A'}</div>
            ...
            <div className="row mb-3">
              ...
              <div className="col-sm-6"><strong>Created:</strong> {new Date(viewCampaign.createdAt).toLocaleDateString()}</div>
            </div>
