...
//     try {
//       const response = await getAPI("/api/how-to-bid");
//       const data = Array.isArray(response.data.data) ? response.data.data : [];
//       setPages(data);
//     } catch (error) {
//       console.error("Error fetching How to Bid pages:", error);
...
//     try {
//       await axiosInstance.delete(`/api/how-to-bid/delete/${id}`);
...
//                 onClick={() => navigate("/super-admin/how-to-bid/create")}
//               >
...
//                             title="Edit"
//                             onClick={() =>
//                               navigate("/super-admin/how-to-bid/update", {
//                                 state: { page },
//                               })
//                             }
//                           >
...
const HowToBidTable = () => {
  ...
  const handleSEOSubmit = async () => {
    try {
      ...
      if (seoData._id) {
        await axiosInstance.put(`/api/how-to-bid/updateSEO/${seoData._id}`, formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
        toast.success("SEO metadata updated successfully.");
      } else {
        await axiosInstance.post("/api/how-to-bid/createSEO", formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
                      ...
                      <tr key={page._id}>
                        ...
                        <td>
                          <button
                            ...
                            title="Edit"
                            onClick={() =>
                              navigate("/super-admin/how-to-bid/update", { state: { page } })
                            }
                          >
                            <i className="fa fa-pencil"></i>
                          </button>
