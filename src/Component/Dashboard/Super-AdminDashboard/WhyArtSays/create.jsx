  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.articles.forEach((article, idx) => {
        ...
        if (article.bannerImage) submissionData.append(`articles[${idx}][bannerImage]`, article.bannerImage);
        if (article.existingBanner) submissionData.append(`articles[${idx}][existingBanner]`, article.existingBanner);
      });

      const res = await postAPI("/api/whyartsays/create", submissionData, {
  ...
  return (
    <div className="container-fluid">
      <div className="block-header">
        <h2>Create Why Art Says Page</h2>
...
export default WhyArtSaysAdmin;
