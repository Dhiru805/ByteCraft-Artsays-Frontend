...
const UpdateWhyArtSays = () => {
  ...
  useEffect(() => {
    if (!page) {
      toast.error("No Why Art Says page data provided.");
      navigate("/super-admin/why-artsays");
    } else {
      setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await putAPI(`/api/whyartsays/update/${page._id}`, submissionData, {
        headers: { "Content-Type": "multipart/form-data" },
      });

      if (response.data.data) {
        toast.success("Why Art Says page updated successfully!");
        navigate("/super-admin/why-artsays", { state: { reload: true } });
      } else {
  ...
  return (
    <div className="container-fluid">
      <div className="block-header">
        <h2>Update Why Art Says Page</h2>
...
export default UpdateWhyArtSays;
