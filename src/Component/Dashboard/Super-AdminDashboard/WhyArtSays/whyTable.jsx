...
//     try {
//       const response = await getAPI("/api/whyartsays");
...
//                 onClick={() =>
//                   navigate("/super-admin/why-artsays/create")
//                 }
//               >
...
//                             title="Edit"
//                             onClick={() =>
//                               navigate("/super-admin/why-artsays/update", {
//                                 state: { page },
//                               })
//                             }
//                           >
...
// export default WhyArtSaysTable;
...
//   const handleDeleteConfirmed = async (id) => {
//     try {
//       const res = await axiosInstance.delete(`/api/whyartsays/delete/${id}`);

//       if (res?.data?.success) {
//         toast.success("Page deleted successfully");

//         // Remove item from table without refresh
...
//       if (seoData._id) {
//         await axiosInstance.put(`/api/whyartsays/updateSEO/${seoData._id}`, formData, {
//           headers: { "Content-Type": "multipart/form-data" },
//         });
//         toast.success("SEO metadata updated successfully.");
//       } else {
//         await axiosInstance.post("/api/whyartsays/createSEO", formData, {
//           headers: { "Content-Type": "multipart/form-data" },
//         });
...
//               <button
//                 className="btn btn-secondary"
//                 onClick={() => navigate("/super-admin/why-artsays/create")}
//               >
//                 <i className="fa fa-plus"></i> Add Page
//               </button>
//             </div>
...
//               <h5>Why ArtSays SEO Metadata</h5>
