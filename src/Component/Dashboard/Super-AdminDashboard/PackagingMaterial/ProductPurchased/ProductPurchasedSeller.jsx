...
const ProductPurchased = () => {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                const url = `${process.env.REACT_APP_API_URL}/api/getseller-purchasedproductbyid/${encodeURIComponent(userId)}`;
                                                    ...
                                                    <td>
                                                        {productData && (
                                                            <button className="btn btn-sm btn-outline-info mr-2"
                                                                onClick={() => navigate(`/${userType}/Dashboard/packagingproductpurchased/productdetails/${product.product._id}`)}>
