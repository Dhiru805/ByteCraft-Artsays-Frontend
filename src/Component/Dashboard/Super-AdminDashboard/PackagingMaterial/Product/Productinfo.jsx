...
function AllProduct() {
    ...
    const [selectedToDelete, setSelectedProductToDelete] = useState(null);
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const result = await getAPI(`${process.env.REACT_APP_API_URL}/api/getproductbyid/${productId}`, {}, true, false);
    ...
    const handleDeleteConfirmed = () => {
        setProducts(null);
        setIsDeleteDialogOpen(false);
        navigate(`/${userType}/Dashboard/packagingmaterialproduct`);
    };
...
const handleEdit = (product) => {
    navigate(`/${userType}/Dashboard/packagingmaterialproduct/productdetails/updateproduct/${product._id}`, { state: product });
};
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">
                                <Link to={`/${userType}/Dashboard/packagingmaterialproduct`} >All Product</Link></li>
                                        ...
                                        {userType === "Super-Admin" && (
                                            <>
                                                ...
                                                <button className="btn btn-outline-danger mx-2"
                                                     onClick={() => openDeleteDialog(product)}>Delete</button>
                                            </>
                                        )}
                                    </div>
                                </div>
