...
const Transaction = () => {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                const result = await getAPI(`${process.env.REACT_APP_API_URL}/api/getseller-producttransactionbyid/${encodeURIComponent(userId)}`, {}, true, false);
                                                    ...
                                                    <td>
                                                        {productData && (
                                                            <button className="btn btn-sm btn-outline-info mr-2"
                                                                onClick={() => navigate(`/${userType}/Dashboard/packagingproducttransaction/productdetails/${product.product._id}`)}>
