...
//     try {
//       const response = await getAPI("/api/licensing");
...
//     try {
//       await axiosInstance.delete(`/api/licensing/delete/${id}`);
...
//                 onClick={() => navigate("/super-admin/licensing/create")}
//               >
...
//                             title="Edit"
//                             onClick={() =>
//                               navigate("/super-admin/licensing/update", {
//                                 state: { page },
//                               })
//                             }
//                           >
...
const LicensingTable = () => {
  ...
  const handleSEOSubmit = async () => {
    try {
      ...
      if (seoData._id) {
        await axiosInstance.put(`/api/licensing/updateSEO/${seoData._id}`, formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
        toast.success("SEO metadata updated successfully.");
      } else {
        await axiosInstance.post("/api/licensing/createSEO", formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
                      ...
                      <tr key={page._id}>
                        ...
                        <td className="text-center">
                          <button
                            ...
                            title="Edit"
                            onClick={() =>
                              navigate("/super-admin/licensing/update", { state: { page } })
                            }
                          >
                            <i className="fa fa-pencil"></i>
                          </button>
