...
const Transaction = () => {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                const result = await getAPI(`${process.env.REACT_APP_API_URL}/api/getallresellproducttransaction/${encodeURIComponent(userId)}`, {}, true, false);
                ...
                <div className="row">
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item">Resell Transaction</li>
                        </ul>
                    </div>
                </div>
            </div>
                                                    ...
                                                    <td>
                                                        {productData && (
                                                            <button className="btn btn-sm btn-outline-info mr-2"
                                                                onClick={() => navigate(`/${userType}/Dashboard/reselltransaction/transcationproductdetails/${product._id}`)}>
