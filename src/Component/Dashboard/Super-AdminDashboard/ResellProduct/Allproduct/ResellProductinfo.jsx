...
function AllProduct() {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const result = await getAPI(`${process.env.REACT_APP_API_URL}/api/getbuyerproductbyid/${productId}`, {}, true, false);
    ...
    const handleEdit = (productId,userId) => {
        ...
        navigate(`/${userType}/Dashboard/allresellproduct/productdetails/editproduct/${userId}`);
    };
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">
                                <Link to={`/${userType}/Dashboard/allresellproduct`}>All Resell Product</Link></li>
                                        ...
                                        {product.userId && (
                                            <>
                                                <button className="btn btn-outline-dark ms-2"
                                                    onClick={() => handleEdit(product._id,product.userId?._id)}>Edit</button>
                                    ...
                                    <div className="col-12">
                                        ...
                                        <div className="tab-content mt-3">
                                            ...
                                            <div className={`tab-pane ${activeTab === "artist" ? "active" : ""}`}>
                                                {activeTab === "artist" && (
                                                    <>
                                                        {(product.buyerId || product.userId) ? (
                                                            <>
                                                                {product.buyerId && (
                                                                    <>
                                                                        <p><strong>Name:</strong> <span style={{ marginLeft: "10px" }}>{product.buyerId.name} {product.buyerId.lastName}</span></p>
                                                                        <p><strong>Email:</strong> <span style={{ marginLeft: "10px" }}>{product.buyerId.email}</span></p>
                                                                        <p><strong>Website:</strong>
                                                                            {product.buyerId.website ? (
                                                                                <a
                                                                                    href={product.buyerId.website}
                                                                                    target="_blank"
