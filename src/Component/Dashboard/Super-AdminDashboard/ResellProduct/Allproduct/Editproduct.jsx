                ...
                <div className="row">
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item">
                                <Link to={`/${userType}/Dashboard/allresellproduct`} >Resell Product</Link></li>
                                <li className="breadcrumb-item">
                                <Link to={`/${userType}/Dashboard/allresellproduct/productdetails/${userId}`} >Product View</Link></li>
