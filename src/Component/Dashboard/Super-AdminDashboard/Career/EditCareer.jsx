...
function CareerEdit() {
  ...
  useEffect(() => {
    if (!career) {
      toast.error("No career data provided. Please select a career to edit.");
      navigate("/careers");
      return;
    }
  }, [career, navigate]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await putAPI(`/api/update-career/${career._id}`, payload);
        ...
        <div className="row">
          <div className="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul className="breadcrumb">
              ...
              <li className="breadcrumb-item">Update Job Post</li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div className="body">
              <form onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  disabled={loading}
                >
                  {loading ? "Updating Job Post..." : "Update Job Post"}
                </button>
              </form>
            </div>
          </div>
