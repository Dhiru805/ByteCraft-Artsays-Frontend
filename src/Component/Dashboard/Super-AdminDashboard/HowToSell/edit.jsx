...
const UpdateHowToSell = () => {
  ...
  useEffect(() => {
    if (!page) {
      toast.error("No How To Sell page data provided.");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await putAPI(`/api/howtosell/update/${page._id}`, submissionData, {
        headers: { "Content-Type": "multipart/form-data" },
      });

      if (response.data.data) {
        toast.success("How To Sell page updated successfully!");
        navigate("/super-admin/how-to-sell", { state: { reload: true } });
      } else {
        toast.error(response.data.message || "Failed to update How To Sell page");
      }
    } catch (error) {
...
export default UpdateHowToSell;
