...
//     try {
//       const response = await getAPI("/api/howtosell");
...
//     try {
//       await axiosInstance.delete(`/api/howtosell/delete/${id}`);
...
//                 onClick={() => navigate("/super-admin/how-to-sell/create")}
//               >
...
//                             title="Edit"
//                             onClick={() =>
//                               navigate("/super-admin/how-to-sell/update", {
//                                 state: { page },
//                               })
//                             }
//                           >
...
const HowToSellTable = () => {
  ...
  const handleSEOSubmit = async () => {
    try {
      ...
      if (seoData._id) {
        await axiosInstance.put(`/api/howtosell/updateSEO/${seoData._id}`, formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
        toast.success("SEO metadata updated successfully.");
      } else {
        await axiosInstance.post("/api/howtosell/createSEO", formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
                      ...
                      <tr key={page._id}>
                        ...
                        <td style={{ whiteSpace: "nowrap" }}>
                          <button
                            className="btn btn-outline-info btn-sm mr-1"
                            onClick={() =>
                              navigate("/super-admin/how-to-sell/update", { state: { page } })
                            }
                          >
                            <i className="fa fa-pencil"></i>
                          </button>
        ...
        <div className="modal-backdrop">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content p-3">
              <h5>How To Sell SEO Metadata</h5>
