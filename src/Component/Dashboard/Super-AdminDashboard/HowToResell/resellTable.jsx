...
//     try {
//       const response = await getAPI("/api/how-to-resell");
//       const data = Array.isArray(response.data.data) ? response.data.data : [];
//       setPages(data);
//     } catch (error) {
//       console.error("Error fetching How To Resell pages:", error);
...
//     try {
//       await axiosInstance.delete(`/api/how-to-resell/delete/${id}`);
...
//                 onClick={() => navigate("/super-admin/how-to-resell/create")}
//               >
...
//                             title="Edit"
//                             onClick={() =>
//                               navigate("/super-admin/how-to-resell/update", {
//                                 state: { page },
//                               })
//                             }
//                           >
...
// export default HowToResellTable;
...
const HowToResellTable = () => {
  ...
  const handleSEOSubmit = async () => {
    try {
      ...
      if (seoData._id) {
        await axiosInstance.put(`/api/how-to-resell/updateSEO/${seoData._id}`, formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
        toast.success("SEO metadata updated successfully.");
      } else {
        await axiosInstance.post("/api/how-to-resell/createSEO", formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
        ...
        <div className="col-lg-12">
          <div className="card">
            ...
            <div className="body">
                      ...
                      <tr key={page._id}>
                        ...
                        <td>
                          <button
                            ...
                            title="Edit"
                            onClick={() =>
                              navigate("/super-admin/how-to-resell/update", { state: { page } })
                            }
                          >
                            <i className="fa fa-pencil"></i>
                          </button>
              ...
              <div className="pagination d-flex justify-content-between mt-4">
                <span className="mx-1 d-none d-sm-inline-block text-truncate w-100">
                  Showing {filteredPages.length === 0 ? 0 : (currentPage - 1) * pagesPerPage + 1} to{" "}
                  {Math.min(currentPage * pagesPerPage, filteredPages.length)} of {filteredPages.length} entries
                </span>
                <ul className="pagination d-flex justify-content-end w-100">
        ...
        <div className="modal-backdrop">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content p-3">
              <h5>How To Resell SEO Metadata</h5>
              <div className="form-group">
                <label>Meta Title</label>
                <input type="text" name="metaTitle" value={seoData.metaTitle} onChange={handleSEOChange} className="form-control" />
              </div>
              <div className="form-group">
                <label>Meta Description</label>
                <textarea name="metaDescription" value={seoData.metaDescription} onChange={handleSEOChange} className="form-control" />
              </div>
              <div className="form-group">
                <label>Meta Keywords (comma separated)</label>
                <input type="text" name="metaKeywords" value={seoData.metaKeywords} onChange={handleSEOChange} className="form-control" />
              </div>
              <div className="form-group">
                <label>Meta Author</label>
                <input type="text" name="metaAuthor" value={seoData.metaAuthor} onChange={handleSEOChange} className="form-control" />
              </div>
              <div className="form-group">
                <label>Meta Image</label>
                <input type="file" name="metaImage" onChange={handleSEOChange} className="form-control" />
                {/* {seoData.metaImage && (
                  <div className="mt-2">
                    <img
