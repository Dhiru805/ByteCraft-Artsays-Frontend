...
function HowToResellAdmin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await postAPI("/api/how-to-resell/create", submissionData, {
  ...
  return (
    <div className="container-fluid">
      <div className="block-header">
        <h2>Create How To Resell Page</h2>
...
export default HowToResellAdmin;
