...
const UpdateHowToResell = () => {
  ...
  useEffect(() => {
    if (!page) {
      toast.error("No How To Resell page data provided.");
      navigate("/super-admin/how-to-resell");
    } else {
      setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await putAPI(`/api/how-to-resell/update/${page._id}`, submissionData, {
        headers: { "Content-Type": "multipart/form-data" },
      });

      if (response.data.data) {
        toast.success("How To Resell page updated successfully!");
        navigate("/super-admin/how-to-resell", { state: { reload: true } });
      } else {
        toast.error(response.data.message || "Failed to update How To Resell page");
      }
    } catch (error) {
  ...
  return (
    <div className="container-fluid">
      <div className="block-header">
        <div className="row">
          <h2>Update How To Resell Page</h2>
...
export default UpdateHowToResell;
