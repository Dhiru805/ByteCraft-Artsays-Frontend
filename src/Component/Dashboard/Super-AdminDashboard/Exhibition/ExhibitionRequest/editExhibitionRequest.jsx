...
const UpdateExhibitionRequest = () => {
  ...
  useEffect(() => {
    if (!exhibition) {
      ...
      navigate("/super-admin/exhibition-request");
    } else {
      setFormData({
      ...
      <div className="block-header">
        <div className="row">
          <div className="col-lg-6 col-md-6 col-sm-12">
            <h2>Update Exhibition Request</h2>
            <ul className="breadcrumb">
              ...
              <li className="breadcrumb-item">
                <span onClick={() => navigate("/super-admin/exhibition-request")} style={{ cursor: "pointer" }}>
                  Exhibitions Request
                </span>
              </li>
              <li className="breadcrumb-item active">Update Exhibition Request</li>
            </ul>
          </div>
        </div>
      </div>
...
export default UpdateExhibitionRequest;