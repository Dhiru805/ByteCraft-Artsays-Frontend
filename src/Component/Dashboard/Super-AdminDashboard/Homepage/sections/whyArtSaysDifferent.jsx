    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            for (let i = 0; i < cards.length; i++) {
                const c = cards[i];
                if (!c.title.trim() || !c.description.trim() || !c.hexColor.trim() || (!c.icon && !c.existingIcon)) {
            ...
            cards.forEach((c, idx) => {
                ...
                if (c.icon) {
                    submissionData.append(`cards[${idx}][icon]`, c.icon);
                } else if (c.existingIcon) {
                    submissionData.append(`cards[${idx}][existingIcon]`, c.existingIcon);
                }
            });
    ...
    return (
        <div className="container-fluid">
            <div className="block-header">
                <h2>{sectionId ? "Edit Why Artsays Different Section" : "Create Why Artsays Different Section"}</h2>
                                    ...
                                    <div key={idx} className="border mb-3 p-3 rounded shadow">
                                        ...
                                        <div className="form-group">
                                            ...
                                            {(iconPreviews[idx] || c.existingIcon) && (
                                                <div className="mt-2">
                                                    <img src={iconPreviews[idx] || c.existingIcon} alt="Icon Preview" style={{ maxWidth: "80px", maxHeight: "80px" }} />
                                                </div>
                                            )}
                                        </div>
