...
const ApprovedProduct = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const result = await getAPI("/api/getstatusapprovedproduct", {}, true, false);
                                            ...
                                            <tr key={product._id}>
                                                ...
                                                <td>
                                                    {product.sellingPrice !== undefined
                                                        ? new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR' }).format(product.sellingPrice).replace(/\.00$/, '')
                                                        : 'N/A'}
                                                </td>
