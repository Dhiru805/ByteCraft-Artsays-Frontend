    ...
    const fetchProducts = async () => {
      ...
      try {
        const result = await getAPI(
          "/api/getpackagingmaterialproductartist",
          {},
          true,
          false
        );
                  ...
                  <table className="table table-hover">
                    ...
                    <tbody>
                      {displayedProducts.map((product, index) => {
                        const productData =
                          product.product || product.resellProduct;
                        return (
                          <tr key={product._id}>
                            <td>
                            ...
                            <td>
                              {productData && (
                                <button
                                  ...
                                  onClick={() =>
                                    navigate(
                                      `/${userType}/Dashboard/artistpackagingmaterial/productdetails/${product.product._id}`
                                    )
                                  }
                                >
