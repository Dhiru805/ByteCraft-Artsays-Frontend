...
//     try {
//       const response = await getAPI("/api/affiliate-bp");
...
//     try {
//       await axiosInstance.delete(`/api/affiliate-bp/delete/${id}`);
...
//             <h2>Affiliate Brand Partner Pages</h2>
//           </div>
//           <div className="col-lg-6 col-md-6 col-sm-12">
//             <div className="d-flex flex-row-reverse">
//               <button
//                 className="btn btn-secondary"
//                 onClick={() => navigate("/super-admin/affiliate-bp/create")}
//               >
...
//                             title="Edit"
//                             onClick={() =>
//                               navigate("/super-admin/affiliate-bp/update", {
//                                 state: { page },
//                               })
//                             }
//                           >
...
// export default AffiliateBPTable;
...
const AffiliateBPTable = () => {
  ...
  const handleSEOSubmit = async () => {
    try {
      ...
      if (seoData._id) {
        await axiosInstance.put(`/api/affiliate-bp/updateSEO/${seoData._id}`, formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
        toast.success("SEO metadata updated successfully.");
      } else {
        await axiosInstance.post("/api/affiliate-bp/createSEO", formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
        ...
        <div className="col-lg-12">
          <div className="card">
            ...
            <div className="body">
                      ...
                      <tr key={page._id}>
                        ...
                        <td>
                          <button
                            className="btn btn-outline-info btn-sm mr-1"
                            onClick={() =>
                              navigate("/super-admin/affiliate-bp/update", { state: { page } })
                            }
                          >
                            <i className="fa fa-pencil"></i>
                          </button>
              ...
              <div className="pagination d-flex justify-content-between mt-4">
                <span>
                  Showing {filteredPages.length === 0 ? 0 : (currentPage - 1) * pagesPerPage + 1}{" "}
                  to {Math.min(currentPage * pagesPerPage, filteredPages.length)} of {filteredPages.length} entries
                </span>
        ...
        <div className="modal-backdrop">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content p-3">
              <h5>Affiliate BP SEO Metadata</h5>
