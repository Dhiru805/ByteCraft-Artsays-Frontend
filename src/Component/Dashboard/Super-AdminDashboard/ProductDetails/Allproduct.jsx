...
const ApprovedProduct = () => {
    ...
    //     const fetchProducts = async () => {
    //         try {
    //             const result = await getAPI(`/api/all-product-data`, {}, true, false);

    //             console.log("All Product API Response:", result);

    //             if (result?.data?.data?.products && Array.isArray(result.data.data.products)) {
    //                 setProducts(result.data.data.products);
    //             } else {
    //                 console.error("API returned invalid product format:", result.data);
    //                 setProducts([]);
    //             }
    //         } catch (error) {
    //             console.error("Error fetching products:", error);
        ...
        const fetchProducts = async () => {
            try {
                ...
                if (Array.isArray(productsArray)) {
                    ...
                    console.error("Products array missing:", result.data);
                    setProducts([]);
                }
    ...
    const filteredProducts = products.filter(product => {
        const fullName = `${product.userId?.name || "Unknown"} ${product.userId?.lastName || ""}`.toLowerCase();
        return fullName.includes(searchTerm.toLowerCase());
    });
...
`)}
                                                    ...
                                                    {(() => {
                                                        console.log("PRODUCT INSIDE TABLE:", product);
