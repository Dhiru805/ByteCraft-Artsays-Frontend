    ...
    const fetchProducts = async () => {
      try {
        const result = await getAPI(
          `${process.env.REACT_APP_API_URL}/api/getsellerproductbyid/${userId}`,
          {},
          true,
          false
        );
                      ...
                      <tr key={product._id}>
                        ...
                        <td>
                          <button
                            ...
                            onClick={() =>
                              navigate(
                                `/${userType}/Dashboard/productrequest/productdetails/${product.userId._id}`
                              )
                            }
                          >
...
>>>>>>> d2232dfeef2e52ebe7a34f87e7359631bf68283a
};
