...
function AllProduct() {
    ...
    const handleDeleteConfirmed = () => {
        setProducts(null);
        setIsDeleteDialogOpen(false);
        navigate(`/${userType}/Dashboard/artistmanagetable/artistprofile/${userId}`);
    };
    ...
    const handleEdit = (productId) => {
        ...
        navigate(`/${userType}/Dashboard/artistmanagetable/artistprofile/${userId}/productrequestdetails/editproduct/${productId}`, { state: { userId } });
    };
