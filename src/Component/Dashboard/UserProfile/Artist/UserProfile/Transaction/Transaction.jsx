...
const fetchProducts = async () => {
    try {
        const result = await getAPI(`${process.env.REACT_APP_API_URL}/api/get-alltransactionbyartistid/${userId}`, {}, true, false);
                                                ...
                                                <tr key={product._id}>
                                                    ...
                                                    <td>
                                                        {productData && (
                                                             ...
                                                             onClick={() => navigate(`/${userType}/Dashboard/artistmanagetable/artistprofile/${userId}/transactionproductdetails/${product._id}`, { state: { userId } })}
                                                         >
