...
function AllProduct() {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const result = await getAPI(`${process.env.REACT_APP_API_URL}/api/getproduct/${productId}`, {}, true, false);
    ...
    const handleDeleteConfirmed = () => {
        setProducts(null);
        setIsDeleteDialogOpen(false);
        navigate(`/${userType}/Dashboard/artistmanagetable/sellerprofile/${userId}`);
    };
    ...
    const handleEdit = (productId) => {
        ...
        navigate(`/${userType}/Dashboard/artistmanagetable/artistprofile/${userId}/artistproductdetails/editprdouct/${productId}`, { state: { userId } });
    };
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">
                                <Link to={`/${userType}/Dashboard/artistmanagetable`} >Artist Management</Link></li>
                            <li className="breadcrumb-item active">
                                <Link to={`/${userType}/Dashboard/artistmanagetable/artistprofile/${userId}`} >Artist Profile</Link></li>
                            <li className="breadcrumb-item ">Artist Product Details</li>
                        </ul>
                    </div>
                </div>
            </div>
