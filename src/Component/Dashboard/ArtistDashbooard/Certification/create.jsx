      ...
      const fetchProducts = async () => {
        try {
          ...
          if (!response.hasError) {
            ...
            const categories = [
              ...new Set(
                response.data.data.map((product) => product.mainCategory._id)
              ),
            ];
        ...
        try {
          ...
          if (!response.hasError && Array.isArray(response.data.data)) {
            ...
            if (filteredCertifications.length === 0) {
              toast.warn(
                "No certifications available for the selected product's category."
              );
            }
          } else {
  ...
  const handleChange = (name, value) => {
    if (name === "certifications") {
      ...
      setFormData((prev) => ({
        ...prev,
        [name]: value,
        mainCategories: selectedProduct
          ? [selectedProduct.mainCategory._id]
          : [],
        certifications: [],
      }));
    } else {
        ...
        <div className="row">
          <div className="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul className="breadcrumb">
              ...
              <li className="breadcrumb-item">
                <a href="/artist/certification">Certification</a>
              </li>
              ...
              <form onSubmit={handleSubmit}>
                <div className="form-group">
                  ...
                  <Select
                    ...
                    onChange={(option) =>
                      handleChange("productId", option ? option.value : "")
                    }
                ...
                <div className="form-group">
                  <label htmlFor="certificationProvider">
                  ...
                  <Select
                    ...
                    value={
                      certificationProviderOptions.find(
                        (option) =>
                          option.value === formData.certificationProvider
                      ) || null
                    }
                    onChange={(option) =>
                      handleChange(
