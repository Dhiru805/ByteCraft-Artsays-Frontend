                                    ...
                                    <table className="table table-hover js-basic-example dataTable table-custom m-b-0 c_list">
                                        ...
                                        <tbody>
                                            {displayedProducts.map((request, index) => {
                                                ...
                                                const hasValidBuyer = request.Buyer && request.Buyer.id;
                                                return (
                                                    <tr key={request._id}>
                                                        <td>
                                                        ...
                                                        <td>
                                                            {hasValidBuyer ? (
                                                                <>
                                                                    <img
                                                                        src={`${BASE_URL}${request.Buyer.id.profilePhoto || 'default-image.png'}`}
                                                                ...
                                                                <p className="c_name">N/A</p>
                                                            )}
                                                        </td>
                                                        <td>{hasValidBuyer ? request.Buyer.id.email : 'N/A'}</td>
                                                        <td>{hasValidBuyer ? request.Buyer.id.phone : 'N/A'}</td>
                                                        <td>{request.ProductName || 'N/A'}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            >
                                                                {request.RequestStatus || 'N/A'}
                                                            </button>
                                                        </td>
                                                        <td>
                                                            <button
                                                                className={`btn btn-sm ${request.BuyerStatus === 'Pending'
                                                                    ? 'btn-outline-warning'
                                                        ...
                                                        <td>
                                                            ...
                                                            {hasValidBuyer && updatedRequests[request._id] !== 'approved' && (
                                                                <button
                                                                    type="button"
                                                            ...
                                                            {hasValidBuyer && updatedRequests[request._id] !== 'rejected' && (
                                                                <button
                                                                    type="button"
                                                            ...
                                                            {request.RequestStatus === 'Approved' && hasValidBuyer && (
                                                                <button
                                                                    type="button"
