...
//     const res = await putAPI(`/api/bidding/products/${id}`, form, true, false);
...
//       <input name="reservePrice" value={form.reservePrice} onChange={handleChange} />
...
//       <select name="bidProdStatus" value={form.bidProdStatus} onChange={handleChange}>
