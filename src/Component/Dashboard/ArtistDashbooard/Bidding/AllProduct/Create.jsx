...
const CreateBiddingProduct = () => {
  ...
  console.log("formeeeeeeeeeee", form);
  const handleSubmit = async () => {
    if (!passDetails) {
    ...
    try {
      await axiosInstance.post("/api/bidding/products/create", form);
            ...
            <div className="card p-4">
              ...
              <div className="form-group mt-3" style={{ position: "relative" }}>
                ...
                <div className="relative w-full">
                  <input
                    type="text"
                    className="form-control relative z-10"
                    placeholder={
