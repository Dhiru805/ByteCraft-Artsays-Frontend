...
const res = await axios.get(`${API_URL}/auth/userid/${userId}`, { headers: authHeaders });
  ...
  const crNew = customRequests.filter((r) => r.RequestStatus === "Pending").length;
  ...
  const crOrdered = customRequests.filter(
    (r) => r.RequestStatus === "Approved" && r.BuyerStatus === "Approved" && r.OrderStatus === "Ordered"
  ).length;
    ...
    <div className="container-fluid">
          ...
          <div className="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul className="breadcrumb">
              <li className="breadcrumb-item">
                <a href="/artist/dashboard"><i className="fa fa-dashboard"></i></a>
              </li>
            ...
            <div className="d-none d-md-flex flex-row-reverse">
              <div className="page_action">
                ...
                <Link to="/artist/custom-order" className="btn btn-secondary">
                  <i className="fa fa-paint-brush"></i> Custom Orders
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            <div className="header">
              ...
              <ul className="header-dropdown">
                <li>
                  <Link to="/artist/wallet" title="View Wallet">
      ...
      <div className="row clearfix row-deck">
        <div className="col-lg-6 col-md-12">
          ...
          <div className="card">
            <div className="header d-flex justify-content-between">
              <h2>Custom Orders <small>Buyer requests for your artwork</small></h2>
              <div className="d-none d-md-block">
                <Link to="/artist/custom-order" className="btn btn-primary btn-sm btn-block">
                  Custom Orders
                </Link>
              </div>
            </div>
          ...
          <div className="card">
            ...
            <div className="body">
              <ul className="list-group list-group-flush">
                {[
                  { text: "New Exhibition invites available", badge: "badge-primary", link: "/artist/exhibition" },
        ...
        <div className="col-lg-4 col-md-6 col-sm-12">
          <div className="card">
            <div className="header">
              ...
              <ul className="header-dropdown">
                <li>
                  <Link to="/artist/bidding-products-table" title="View All">
                    <i className="fa fa-external-link"></i>
                  </Link>
                </li>
              </ul>
