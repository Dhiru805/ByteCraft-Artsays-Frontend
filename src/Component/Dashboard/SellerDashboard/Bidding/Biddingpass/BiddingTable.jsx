...
//                     className="btn btn-secondary mr-2"
//                     onClick={() =>
//                       navigate(`/seller/bidding-pass-table/upgrade`)
//                     }
//                   >
//                     {" "}
//                     Upgrade
...
//                     className="btn btn-secondary mr-2"
//                     onClick={() =>
//                       navigate(`/seller/bidding-pass-table/bidding-pass`)
//                     }
//                   >
//                     {" "}
//                     Order
...
const BiddingTable = () => {
  ...
  const filtered = orders.filter((o) => {
    ...
    const matchesSearch = uname.includes(searchTerm.toLowerCase()) || passName.includes(searchTerm.toLowerCase());
    const matchesUserFilter = userFilter === "all" || uname === userFilter.toLowerCase();
    const matchesPassFilter = passFilter === "all" || passName === passFilter.toLowerCase();
    const matchesStatusFilter =
      statusFilter === "all" ||
      (statusFilter === "active" && o.active) ||
      (statusFilter === "inactive" && !o.active);

    return matchesSearch && matchesUserFilter && matchesPassFilter && matchesStatusFilter;
  });
                      ...
                      paginated.map((order, index) => (
                        <tr key={order._id}>
                          ...
                          <td>
                            <span
                              className={`badge ${
                                order.active ? "badge-success" : "badge-secondary"
                              }`}
                            >
                              {order.active ? "Active" : "Inactive"}
                            </span>
