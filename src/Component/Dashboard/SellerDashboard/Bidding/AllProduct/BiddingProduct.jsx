        ...
        <div className="row">
          ...
          <div className="col-lg-6 text-right">
            <button
              ...
              onClick={() => navigate("/seller/bidding-products-table/create")}
            >
                      ...
                      <tr key={item._id}>
                        ...
                        <td>
                          <button
                            ...
                            onClick={() =>
                              navigate(`/seller/bidding-products-table/edit/${item._id}`)
                            }
                          >
...
export default SellerBiddingProducts;
