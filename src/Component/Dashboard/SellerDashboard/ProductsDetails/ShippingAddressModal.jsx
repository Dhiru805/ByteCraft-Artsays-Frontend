...
const AddressModal = ({ isOpen, onClose, productId }) => {
  ...
  const fetchDefaultAddress = async () => {
    ...
    try {
      const response = await getAPI(
        `/api/get-default-shipping-address/${productId}`,
        {},
        true,
        false
      );
      if (!response.hasError && response.data?.data) {
        ...
        setError(response.message || 'No default address found for this product.');
      }
    } catch (err) {
  ...
  const handleSetDefault = async (addressId) => {
    ...
    try {
      const response = await putAPI(
        ...
        { productId, addressId, isDefault: true, userId },
        true,
        false
      );
      if (!response.hasError) {
  ...
  if (!userId) {
    return (
      ...
      >
        ...
        >
          <p>Please log in to manage shipping addresses.</p>
  ...
  />
        ...
        <SetDefaultConfirmationDialog
          ...
          message="Are you sure you want to set this address as default for this product?"
        />
      </div>
    </div>
  );
