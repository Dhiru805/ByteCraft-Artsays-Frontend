...
const ProductPurchased = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const result = await getAPI("http://localhost:3001/api/getpackagingmaterialproductbuyer", {}, true, false);
            ...
            <div className="block-header">
                <div className="row">
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <h2>Buyer Packaging Material</h2>
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item">Buyer Packaging Material</li>
                        </ul>
                    </div>
                </div>
            </div>
                                                    ...
                                                    <td>
                                                        {productData && (
                                                            <button className="btn btn-sm btn-outline-info mr-2"
                                                                onClick={() => navigate(`/${userType}/Dashboard/buyerpackagingmaterial/productdetails/${product.product._id}`)}>
