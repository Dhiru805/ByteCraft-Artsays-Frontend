...
function AllProduct() {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const result = await getAPI(`http://localhost:3001/api/getbuyerproductbyid/${productId}`, {}, true, false);
    ...
    const handleEdit = (productId,userId) => {
        ...
        navigate(`/${userType}/Dashboard/buyerproductrequest/productview/editproduct/${userId}`);
    };
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">
                                <Link to={`/${userType}/Dashboard/buyerproductrequest`} >Resell Product Request</Link></li>
