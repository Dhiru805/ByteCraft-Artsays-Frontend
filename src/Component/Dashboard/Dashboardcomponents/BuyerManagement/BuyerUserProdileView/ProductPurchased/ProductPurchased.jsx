...
const ProductPurchased = ({userId}) => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const result = await getAPI(`http://localhost:3001/api/getallpurchasedproduct/${userId}`, {}, true, false);
                                                    ...
                                                    <td>
                                                        {productData && (
                                                            <button className="btn btn-sm btn-outline-info mr-2"
                                                                onClick={() => navigate(`/${userType}/Dashboard/buyermanagetable/buyerprofileview/${userId}/productdetails/${product._id}`,{ state: { userId } })}>
