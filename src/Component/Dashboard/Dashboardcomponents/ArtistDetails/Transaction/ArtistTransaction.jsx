...
const Transaction = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const result = await getAPI("http://localhost:3001/api/gettransactionartist", {}, true, false);
                ...
                <div className="row">
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item">Artist Transaction</li>
                        </ul>
                    </div>
                </div>
            </div>
                                                    ...
                                                    <td>
                                                        {productData && (
                                                            <button className="btn btn-sm btn-outline-info mr-2"
                                                                onClick={() => navigate(`/${userType}/Dashboard/artisttransaction/transcationproductdetails/${product._id}`)}>
