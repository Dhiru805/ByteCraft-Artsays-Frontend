        ...
        <div className="col-lg-9 col-md-12">
          <div className="tab-content padding-0">
            <div className="tab-pane active" id="Overview">
              {blogs.length > 0 ? (
                blogs.map((blog) => (
                  <div key={blog.id} className="card single_post mx-auto mb-4">
                      <div
                ...
                ></div>
                    ...
                    <div className="footer p-3">
                      <ul className="stats list-inline mt-2">
                        <li className="list-inline-item">
                        </li>
                        <li className="list-inline-item">
                          <button
                            className={`btn btn-sm  ${blog.blogStatus === 'Pending' ? 'btn-outline-warning' : blog.blogStatus === 'Approved' ? 'btn-outline-success' : 'btn-outline-danger'}`}
                          >
                            {blog.blogStatus}
                          </button>
                        </li>
...
//               <div style={{ position: 'relative', display: 'inline-block' }}>
//                 <div
//                   className={`status-dot ${overallStatus === 'Pending' ? 'bg-warning' : overallStatus === 'Approved' ? 'bg-success' : 'bg-danger'}`}
//                   style={{ 
//                     position: 'absolute', 
//                     top: '5px', 
//                     left: '180px', 
...
//                       }}>{blog.blogDescription.replace(/<\/?[^>]+(>|$)/g, "")}</p>
//                     </div>
//                     <div className="footer p-3 d-flex justify-content-end align-items-center">
