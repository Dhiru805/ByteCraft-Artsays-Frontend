        ...
        <div className="row">
          <div className="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul className="breadcrumb">
              ...
              <li className="breadcrumb-item"><Link to={`/${userType}/Dashboard/artistblogrequest`}>Artist Blog Request</Link></li>
              <li className="breadcrumb-item"><Link to={`/${userType}/Dashboard/artistblogrequest/viewblog/${blogId}`}>Artist View Blog</Link></li>
