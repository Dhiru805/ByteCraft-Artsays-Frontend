  ...
  const fetchProducts = async () => {
    try {
      const result = await getAPI(
        "http://localhost:3001/api/getallbid",
        {},
        true,
        false
      );
                      ...
                      <tr key={product._id}>
                        ...
                        <td>
                          <button
                            ...
                            onClick={() =>
                              navigate(
                                `/${userType}/Dashboard/allbiddingproduct/productdetails/${product.product._id}`
                              )
                            }
                          >
