...
const BiddedProduct = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const result = await getAPI("http://localhost:3001/api/getbiddedproduct", {}, true, false);
                                                    ...
                                                    <td>
                                                        {productData && (
                                                            <button className="btn btn-sm btn-outline-info mr-2"
                                                                onClick={() => navigate(`/${userType}/Dashboard/transactionbiddedprdouct/productdetails/${productData._id}`)}>
